...
{
    public static class Camera2DGame
    {
        public static Vector2 PositionLeftTop { get; private set; }
        ...
        {
            Position = new Vector2((Game1.PlayerInstance.Boundary.Origin.X - (Globals.Winsize.X / 2) / Globals.ScreenRatio.X), (Game1.PlayerInstance.Boundary.Origin.Y - (Globals.Winsize.Y / 2) / Globals.ScreenRatio.Y));
